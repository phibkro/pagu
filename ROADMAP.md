...
The historical "what shipped" log moved to **[`CHANGELOG.md`](./CHANGELOG.md)**
(2026-05-30) so this file stays forward-only. New shipments: add a
`CHANGELOG.md` entry; the Conventional-Commit log is the dated record.
